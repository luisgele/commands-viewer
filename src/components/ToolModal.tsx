          ...
          <div>
            {isEdit && onDelete && (
              <button
                ...
                onClick={onDelete}
                disabled={saving}
                className="rounded-md border border-[color:var(--color-accent-orange)]/40 bg-[color:var(--color-accent-orange)]/20 px-4 py-2 font-mono text-xs text-[color:var(--color-accent-orange)] hover:bg-[color:var(--color-accent-orange)]/30 disabled:opacity-50"
              >
